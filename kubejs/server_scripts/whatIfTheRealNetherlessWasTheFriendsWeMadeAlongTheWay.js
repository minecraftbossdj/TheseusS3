ServerEvents.recipes(event => {
  ...
  event.recipes.create.haunting('minecraft:ender_pearl', '#forge:slimeballs')
  ...
  event.recipes.create.mixing('minecraft:calcite',["minecraft:stone","minecraft:quartz"])
  event.recipes.create.haunting('minecraft:end_stone', 'minecraft:sandstone')
